...
class _DetailProductScreenState extends State<DetailProductScreen> {
  ...
  final _productRouter = getInstance<ProductRouter>();
  ...
  void _addProductToCart(AddToCartEntity body) {
    context.read<ProductDetailCubit>().addToCart(body);
  }
        ...
        child: BlocConsumer<ProductDetailCubit, ProductDetailState>(
          listener: (context, state) {
            ...
            if (cartState.isError) {
              ...
              _showSuccessAddToCart(state.addToCartState.data!);
            }
          },
                                ...
                                Expanded(
                                  child: CustomButton(
                                    ...
                                    onTap: cartState.isLoading
                                        ? null
                                        : () =>
                                            _addProductToCart(AddToCartEntity(
  ...
  void _showSuccessAddToCart(AddToCartEntity data) {
